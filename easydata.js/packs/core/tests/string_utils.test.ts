...
describe('String Utils', () => {
    it('should правильно повторять строку указанное количество раз', () => {
    ...
    it('should правильно переворачивать строку', () => {
    ...
    it('should правильно проверять, заканчивается ли строка указанным символом', () => {
    ...
    it('should correctly handle случай, когда strEndsWith получает null или undefined', () => {
        expect(strEndsWith(null as any, '.js')).toBe(false);
        expect(strEndsWith(undefined as any, '.txt')).toBe(false);
    });

    it('should correctly объединять пути', () => {
    ...
    it('should correctly handle различные сценарии объединения путей', () => {
